#!/usr/bin/env python3
# -*- coding:utf8 -*-
# @TIME  :2018/8/21 15:39
# @Author:dazhan
# @File  :CA_Prolic_automotive.py
...
class ProlicSpider(Spider):
    name = 'CA_Prolic_automotive'
    base_url = "http://www2.dca.ca.gov/pls/wllpub/WLLQRYNA$LCEV2.QueryList?P_QTE_CODE=SMC&P_QTE_PGM_CODE=1310&P_NAME={lname}&P_RECORD_SET_SIZE=50&Z_ACTION=Find"
    next_url = "http://www2.dca.ca.gov/pls/wllpub/WLLQRYNA$LCEV2.QueryList?P_QTE_CODE=SMC&P_QTE_PGM_CODE=1310&P_NAME={lname}&P_RECORD_SET_SIZE=50&Z_START={start}&Z_ACTION=Next"
    ...
    def parse_info(self, response):
        ...
        prolic = CA_Prolic_automotiveItem()
        for tr in trs:
            tr = tr.text
