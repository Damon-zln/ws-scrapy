...
# @Author:dazhan
# @File  :CA_Prolic_registered_pharmacist.py
...
class ProlicSpider(Spider):
    name = 'CA_Prolic_registered_pharmacist'
    base_url = "http://www2.dca.ca.gov/pls/wllpub/WLLQRYNA$LCEV2.QueryList?P_QTE_CODE=RPH&P_QTE_PGM_CODE=7200&P_NAME={lname}&P_RECORD_SET_SIZE=50&Z_ACTION=Find"
    next_url = "http://www2.dca.ca.gov/pls/wllpub/WLLQRYNA$LCEV2.QueryList?P_QTE_CODE=RPH&P_QTE_PGM_CODE=7200&P_NAME={lname}&P_RECORD_SET_SIZE=50&Z_START={start}&Z_ACTION=Next"
    ...
    def parse_info(self, response):
        ...
        prolic = CA_Prolic_registered_pharmacistItem()
        for tr in trs:
            tr = tr.text
